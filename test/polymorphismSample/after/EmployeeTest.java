...
public class EmployeeTest {
    ...
    // public void hello() {}
     ...
     public void getSalary役員() {
         ...
         Employee employee = employeeFactory.getEmployeeInstanse("役員");
     ...
     public void getSalary管理職() {
         EmployeeFactory employeeFactory = new EmployeeFactory();
         Employee employee = employeeFactory.getEmployeeInstanse("管理職");
     ...
     public void getSalary一般職() {
         EmployeeFactory employeeFactory = new EmployeeFactory();
         Employee employee = employeeFactory.getEmployeeInstanse("一般職");
